...
# =========================================================
# CRAWL (PHASE 1 + AUTO PHASE 2 — RESTORED)
# =========================================================
@app.post("/crawl")
def crawl_blog(req: CrawlRequest):
    ...
    # 🔥 AUTO PHASE 2 — extract links immediately (OLD BEHAVIOR)
    try:
        from services.orchestrator import CrawlOrchestrator
        orchestrator = CrawlOrchestrator()
        orchestrator.run_for_blog(blog_url)
    except Exception as e:
        # Do not fail crawl if extractor errors
        print("AUTO PHASE-2 ERROR:", e)
...
# =========================================================
# OPTIONAL MANUAL PHASE 2 (kept for safety)
# =========================================================
